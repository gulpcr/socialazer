...
import type { URLAnalysis, VideoConfig, VideoScript, Suggestion, ScoreMetrics, VoicePreset } from "@/lib/types"
...
export default function CreateFromURLPage() {
  ...
  const [scores, setScores] = useState<ScoreMetrics>({ engagement: 0, clarity: 0, brandAlignment: 0, callToAction: 0 })
  const [selectedVoice, setSelectedVoice] = useState<VoicePreset | null>(null)
  const [generatedAudioUrl, setGeneratedAudioUrl] = useState<string | null>(null)

  const handleURLAnalyzed = (data: URLAnalysis) => {
    setAnalysis(data)
    setCurrentStep(2)
  }

  const handleContentReviewed = (data: URLAnalysis) => {
    setAnalysis(data)
    setCurrentStep(3)
  }
  ...
  const handleScriptEdited = (data: VideoScript) => {
    ...
    setScores({ engagement: 85, clarity: 90, brandAlignment: 75, callToAction: 80 })
    setCurrentStep(5)
  }
        ...
        <div className="mx-auto max-w-5xl p-6">
          ...
          <div className="mt-8">
            ...
            {currentStep === 6 && script && (
              <VoiceOverStep script={script} onComplete={handleVoiceGenerated} onBack={() => setCurrentStep(5)} />
            )}
...
function generateMockScript(analysis: URLAnalysis, config: VideoConfig): VideoScript {
  ...
  return {
    ...
    scenes: [
      ...
      },
      {
        ...
        textStyle: "cta",
        voiceOver: "Don't wait. Click the link below and transform your experience today!",
  ...
  return [
    {
      ...
      description: "Consider adding urgency with a time-limited offer or exclusive deal.",
      autoApplicable: true,
    },
    {
      id: "sug-2",
      ...
      description: "The problem scene could benefit from more dynamic visuals to capture attention.",
    ...
    },
    {
      ...
      description: "The hook text is slightly long. Consider trimming for better readability.",
      autoApplicable: true,
    },
    {
      id: "sug-4",
      ...
      description: "Consider adding subtle background music to enhance emotional impact.",
      autoApplicable: false,
    },
  ]
}
